...
void Registrator::saveRegisteredContours(Mat depthContourImage, Mat thermalContourImage, string depthSavePath, string thermalSavePath, string imgNbr)
{
	...
	/*
	 * CHANGED SO AS NOT TO SAVE DEPTH MASKS
	 */
...
//	minReg.loadMinCalibrationVars("Data/Sequences/Scene1/calibVars.yml");
//
//	// Set the paths of the trimodal imagery
//	minReg.setRgbImgPath("Data/Sequences/Scene1/SyncRGB/");
//	minReg.setTImgPath("Data/Sequences/Scene1/SyncT/");
//	minReg.setDImgPath("Data/Sequences/Scene1/SyncD/");
//
...
//	minReg.setUsePrevDepthPoint(false);
//
